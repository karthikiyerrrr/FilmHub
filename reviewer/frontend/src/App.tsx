...
function ReviewView({ video, onBack }: { video: string; onBack: () => void }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-surface-0">
      ...
      <div className="flex-1 flex flex-col xl:flex-row min-h-0 px-4 pt-3 pb-2 gap-3">
        {/* Segments — bottom-left on narrow, left column on xl */}
        <div className="hidden xl:flex xl:w-72 xl:shrink-0 xl:min-h-0 xl:overflow-y-auto xl:order-1">
          <SegmentList
            video={video}
        ...
        <div className="hidden xl:block w-px bg-border-subtle shrink-0 xl:order-2" />

        {/* Center: Video + Timeline */}
        <div className="shrink-0 xl:shrink xl:flex-1 xl:min-w-0 xl:order-3 space-y-2">
        ...
        <div className="hidden xl:block w-px bg-border-subtle shrink-0 xl:order-4" />

        {/* Transcript — bottom-right on narrow, right column on xl */}
        <div className="hidden xl:flex xl:w-64 xl:shrink-0 xl:min-h-0 xl:overflow-y-auto xl:order-5">
          <TranscriptPanel
        ...
        {/* Bottom panels — narrow screens only (segments + transcript side by side) */}
        <div className="flex-1 flex min-h-0 gap-3 xl:hidden">
